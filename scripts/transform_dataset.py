...
depths_dir = dataset_path = os.path.join(os.getcwd(), 'datasets', 'nerf_llff_data', sys.argv[1], 'depths')
depth_files = [os.path.join(depths_dir, f) for f in os.listdir(depths_dir)]
